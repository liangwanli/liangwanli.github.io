(() => {
  ...
  const copy = {
    zh: {
      pageTitle: "潘晓枞 | 学术主页", navAbout: "关于", navEducation: "教育", navProjects: "项目", navAwards: "荣誉", menu: "菜单",
      ...
      project3: "探索 MRI 脑肿瘤区域分割方法，覆盖图像预处理、网络实现、指标评估和结果可视化。",
    ...
    en: {
      pageTitle: "Xiaocong Pan | Academic Homepage", navAbout: "About", navEducation: "Education", navProjects: "Projects", navAwards: "Awards", menu: "Menu",
      ...
      project3: "Explored U-Net-based brain tumor segmentation from MRI data, including preprocessing, implementation, metric evaluation, and visualization.",
